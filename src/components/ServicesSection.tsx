      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <div className="px-4 md:px-0">
            <motion.div
              className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-minmax"
              variants={containerVariants}
              initial="hidden"
              animate={isInView ? "visible" : "hidden"}
            >
              {/* Marketing Digital - sempre ocupa uma coluna inteira no mobile */}
              <motion.div
                variants={itemVariants}
                className="col-span-1 md:col-span-6 row-span-auto md:row-span-2"
        ...
        `,
              ...
              {/* Video Showcase - ajustado para mobile */}
              <motion.div
                variants={itemVariants}
                className="col-span-1 md:col-span-6 h-[500px] md:h-auto row-span-2 md:row-span-2"
                whileHover={{ y: -8, transition: { duration: 0.2 } }}
              >
              ...
              {/* Social Media - ajustado para mobile */}
              <motion.div
                variants={itemVariants}
                className="col-span-1 md:col-span-4 row-span-auto md:row-span-1"
                whileHover={{ y: -8, transition: { duration: 0.2 } }}
              ...
              {/* Design Gráfico - ajustado para mobile */}
              <motion.div
                variants={itemVariants}
                className="col-span-1 md:col-span-6 h-[500px] md:h-auto row-span-2 md:row-span-2"
                whileHover={{ y: -8, transition: { duration: 0.2 } }}
              ...
              {/* Code Animation - ajustado para mobile */}
              <motion.div
                variants={itemVariants}
                className="col-span-1 md:col-span-8 row-span-auto md:row-span-1"
                whileHover={{ y: -8, transition: { duration: 0.2 } }}
              >
                    ...
                    <div className="p-6 border-t border-zinc-800">
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                        ...
                        <motion.div
                          ...
                          transition={{ duration: 0.5 }}
                          className="bg-primary-800/50 rounded-lg px-4 py-2 my-3 md:my-0"
                        >
              ...
              <motion.div
                ...
                className="text-center mt-16 col-span-1 md:col-span-12"
              >
                <Button
