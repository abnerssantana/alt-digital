...
const AnimatedHeading: React.FC<AnimatedHeadingProps> = ({ itemVariants }) => {
  ...
  return (
    <motion.h1 
      ...
      className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 relative"
    >
      ...
      {isComplete && (
        ...
        >
          <span className="gradient-text text-4xl md:text-6xl lg:text-7xl font-bold">
            A (ALT)ERNATIVA
